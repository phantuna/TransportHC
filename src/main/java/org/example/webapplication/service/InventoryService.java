...
import org.example.webapplication.service.cache.InventoryCacheService;
...
public class InventoryService {
    ...
    @CacheEvict(value = "inventories_list", allEntries = true)
    @Transactional
    ...
    public PageResponse<InventoryResponse> getAllInventories(int page, int size) {
        ...
        return inventoryCacheService.getAllInventories(page, size);
    }

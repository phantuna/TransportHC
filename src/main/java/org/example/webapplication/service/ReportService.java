...
public class ReportService {
    ...
    public PageResponse<ExpenseSummaryResponse> allTruckExpenseSummaryReport(int page, int size) {
        ...
        Page<ExpenseSummaryResponse> result =
                truckRepository.getAllTruckExpenseSummary(pageable);

        return PageResponse.<ExpenseSummaryResponse>builder()
    ...
    public PageResponse<ExpenseReportDetailResponse> truckExpenseDetail(
            String truckId,
            LocalDate from,
            LocalDate to,
            int page,
        ...
        Page<ExpenseReportDetailResponse> result =
                truckRepository.getExpenseDetailsByTruck(
                        truckId,
                        from,
                        to,
                        pageable
        ...
        return PageResponse.<ExpenseReportDetailResponse>builder()
                .content(new ArrayList<>(result.getContent()))
                .page(result.getNumber())
                .size(result.getSize())
                .totalElements(result.getTotalElements())
